...
public class DeleteNodeInIndexTest implements PerformanceTest {
    ...
    public String shortName() {
        // triangle
        //return "DeleteTriangleNodeTest";
        // movie pattern
        //return "DeleteMoviePatternNodeTest";
        // transaction pattern
        return "DeleteTransactionPatternNodeTest";
    }

    @Override
    public String longName() {
        // triangle
        //return "Delete node from triangle pattern in index.";
        // movie pattern
        //return "Delete node from movie pattern in index.";
        // transaction pattern
        return "Delete node from transaction pattern in index.";
    }
