...
public class CreateRelationshipInIndexTest implements PerformanceTest {
    ...
    public String shortName() {
        // triangle
        //return "CreateTriangleRelationshipTest";
        // movie pattern
        //return "CreateMoviePatternRelationshipTest";
        // transaction pattern
        return "CreateTransactionPatternRelationshipTest";
    }

    @Override
    public String longName() {
        // triangle
        //return "Create relationship to triangle pattern in index.";
        // movie pattern
        //return "Create relationship to movie pattern in index.";
        // transaction pattern
        return "Create relationship to transaction pattern in index.";
    }
